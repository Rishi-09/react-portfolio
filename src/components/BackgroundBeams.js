...
export const BackgroundBeams = () => {
    ...
    useEffect(() => {
        ...
        class SilkLine {
            ...
            thickness;
            segmentCount;
            constructor(yBase, color, opacity, thickness) {
                this.color = color;
    ...
    return (_jsx("canvas", { ref: canvasRef, className: "pointer-events-none fixed inset-0 z-0 opacity-100", style: { filter: 'blur(0.5px)' } }));
};
