...
export const CustomCursor: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const handleOver = (e: MouseEvent) => {
      ...
      const shouldIgnore =
        interactiveEl?.hasAttribute("data-cursor-ignore") ||
  ...
  return (
    <>
      <div
        ref={dotRef}
        className="fixed top-0 left-0 w-1.5 h-1.5 rounded-full pointer-events-none z-[10000] mix-blend-difference"
        style={{
      ...
      <div
        ref={ringRef}
        className="fixed top-0 left-0 rounded-full pointer-events-none z-[9999] border mix-blend-difference"
        style={{
