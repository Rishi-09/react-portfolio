...
export const Magnetic = ({ children, strength = 0.45, scale = 1.02, }) => {
    ...
    return (_jsx("div", { ref: ref, className: "magnetic-target inline-block w-full", style: { willChange: "transform" }, children: safeChild }));
};
